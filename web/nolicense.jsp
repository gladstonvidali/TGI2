...
<HTML>
<HEAD>
<TITLE><%= labels.getString("edmis") %>: License Error</TITLE>
          ...
          <TR>
            ...
            <TD style="VERTICAL-ALIGN: top">
              <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
                <TBODY>
                  <TR>
                    <TD class=headingblock bgColor=#c6bda8>License Error</TD>
                  </TR>
                </TBODY>
              </TABLE>
                        ...
                        <tbody>
                          <tr valign=top>
                            <TD class=courseboxsummary vAlign=top>
                              <P>
                                <FONT size=2>
                              <P>Evaluation License has expired or is obsolete!</P>
                              <P>Please contact vendor for renewal.</P>
                                </FONT></TD>
                          </tr>
                        </tbody>
                      </table>
